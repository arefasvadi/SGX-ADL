...
if(CPPCHECK_HTML_REPORT_ROOT_DIR)
    find_program(CPPCHECK_HTML_REPORT_BIN 
                    NAMES 
                    cppcheck-htmlreport 
                    PATHS
                    "${CPPCHECK_HTML_REPORT_ROOT_DIR}"
    NO_DEFAULT_PATH)
endif()
...
if(CPPCHECK_BIN)
    ...
    set(CPPCHECK_PROJECT_ARG "--project=${PROJECT_BINARY_DIR}/compile_commands.json" CACHE STRING "")
...
if(CPPCHECK_FOUND)
    ...
    add_custom_target(cppcheck-analysis 
        ...
        COMMENT "Running cppcheck! Remember to check html report")
    message("cppcheck found. Use cppccheck-analysis targets to run it")
    if (CPPCHECK_HTML_REPORT_BIN)
        add_custom_target(cppcheck-report 
            COMMAND ${CPPCHECK_HTML_REPORT_BIN} --file ${CPPCHECK_XML_OUTPUT} --report-dir=${PROJECT_BINARY_DIR}/analysis/cppcheck/
            COMMENT "Running cppcheck! html report"
        )
        add_dependencies(cppcheck-report cppcheck-analysis)
    endif()

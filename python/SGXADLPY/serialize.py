...
def process_cifar_10():
    ...
    git_root = find_git_root(current_directory)
    cifar10_out_dir = os.path.join(git_root,"test/config/cifar10/")
    ...
    cifar10_arch_files = [
        ...
        os.path.join(cifar10_out_dir,"archs","batch_128","cifar_small_fc_nobn_g1_e2_b128.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_128",
            "cifar_small_fc_nobn_g2_e2_b128.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_128","cifar_small_avg_nobn_g1_e2_b128.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_128",
            "cifar_small_avg_nobn_g2_e2_b128.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_128","cifar_small_fc_bn_g1_e2_b128.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_128",
            "cifar_small_fc_bn_g2_e2_b128.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_128","cifar_small_avg_bn_g1_e2_b128.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_128",
            "cifar_small_avg_bn_g2_e2_b128.cfg"),
        

        os.path.join(cifar10_out_dir,"archs","batch_256","cifar_small_fc_nobn_g1_e2_b256.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_256",
            "cifar_small_fc_nobn_g2_e2_b256.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_256","cifar_small_avg_nobn_g1_e2_b256.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_256",
            "cifar_small_avg_nobn_g2_e2_b256.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_256","cifar_small_fc_bn_g1_e2_b256.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_256",
            "cifar_small_fc_bn_g2_e2_b256.cfg"),
...
#####################
        ...
        os.path.join(cifar10_out_dir,"archs","batch_128",
            "cifar_vgg16_fc_nobn_g1_e2_b128.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_128",
            "cifar_vgg16_fc_nobn_g1_e4_b128.cfg"),

        os.path.join(cifar10_out_dir,"archs","batch_128",
            "cifar_vgg13_fc_nobn_g1_e1_b128.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_128",
            "cifar_vgg13_fc_nobn_g1_e2_b128.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_128",
            "cifar_vgg13_fc_nobn_g1_e4_b128.cfg"),

        os.path.join(cifar10_out_dir,"archs","batch_128",
            "cifar_vgg11_fc_nobn_g1_e1_b128.cfg"),
        os.path.join(cifar10_out_dir,"archs","batch_128",

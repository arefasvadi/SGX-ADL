...
num_classes = 10
epochs = 100
save_dir = os.path.join(os.getcwd(), 'saved_models/cifar10-90')
model_name = 'keras_cifar10-90_trained_model.h5'
# learning_rate = 0.1
...
model.fit_generator(datagen.flow(x_train, y_train, batch_size=batch_size),\
                    ...
                    callbacks=[EpochWeightsSaver(model, 1),LearningRateScheduler(lr_schedule)])
